                    ...
                    <div class="dropdown login__user">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                            ...
                            <?php if ($_SESSION['rol'] === 'ADMIN') : ?>
                                <li><a class="dropdown-item" href="inicio.php?accion=clients">Todos Clientes</a></li>
                                    ...
                                    <div class="card-container-diet">
                                        <div class="card-diet">
                                            ...
                                            <div class="content-diet">
                                                <button class="btn-delete"><a href="index.php?accion=deleteDiet&id=<?= $diet->getId() ?>" class="link__btn-delete">×</a></button>
